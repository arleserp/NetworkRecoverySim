java  -classpath dist/NetworkSimulator.jar unalcol.agents.NetworkSim.util.GrowthCurveCentralityVsNumberReplicas foresthubandspoke+v+100+clusters+4.graph
