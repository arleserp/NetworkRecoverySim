 ...
 *
 */
public class HubAndSpokeGraphGenerator<V, E> extends Lattice2DGenerator {
     ...
     * @param edge_factory
     */
    public HubAndSpokeGraphGenerator(Factory<? extends Graph<V, E>> graph_factory, Factory<V> vertex_factory,
