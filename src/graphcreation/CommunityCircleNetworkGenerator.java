 ...
 *
 */
public class CommunityCircleNetworkGenerator<V, E> extends Lattice2DGenerator {
     ...
     * neighborhood size.
     */
    public CommunityCircleNetworkGenerator(Factory<? extends Graph<V, E>> graph_factory, Factory<V> vertex_factory,
