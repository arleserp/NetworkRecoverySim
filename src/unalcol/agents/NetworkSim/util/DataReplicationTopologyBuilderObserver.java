 ...
 */
public class DataReplicationTopologyBuilderObserver implements Observer {
    ...
    public DataReplicationTopologyBuilderObserver() {
    ...
    public void update(Observable o, Object arg) {
        if (o instanceof NetworkEnvironmentReplicationTopologyBuilder) {
            final NetworkEnvironmentReplicationTopologyBuilder n = (NetworkEnvironmentReplicationTopologyBuilder) o;
            ...
            if ((SimulationParameters.maxIter == -1 && n.nodesComplete()) || (SimulationParameters.maxIter >= 0 && n.getAge() >= SimulationParameters.maxIter) || n.getAgentsDie() == (n.getAgents().size())) {
                ...
                if (!isUpdating) {
                    isUpdating = true;
                    n.stop();
                    StatisticsProviderReplicationTopologyBuilder sti;
                    ...
                    try {
                        ...
                        Logger.getLogger(DataReplicationTopologyBuilderObserver.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    ...
                    sti = new StatisticsProviderReplicationTopologyBuilder(filename);
