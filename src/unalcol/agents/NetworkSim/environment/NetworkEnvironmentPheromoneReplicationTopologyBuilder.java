...
public class NetworkEnvironmentPheromoneReplicationTopologyBuilder extends NetworkEnvironmentReplicationTopologyBuilder {

    public NetworkEnvironmentPheromoneReplicationTopologyBuilder(Vector<Agent> _agents, SimpleLanguage _language, Graph<GraphElements.MyVertex, String> gr) {
