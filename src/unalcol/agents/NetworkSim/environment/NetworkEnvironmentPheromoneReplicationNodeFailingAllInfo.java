...
public class NetworkEnvironmentPheromoneReplicationNodeFailingAllInfo extends NetworkEnvironmentReplication {
    ...
    public NetworkEnvironmentPheromoneReplicationNodeFailingAllInfo(Vector<Agent> _agents, SimpleLanguage _language, SimpleLanguage _nlanguage, Graph gr) {
    ...
    private void killAgent(MobileAgent a, boolean isMyself) {
        ...
        if (!isMyself) {
            try {
                ...
                Logger.getLogger(NetworkEnvironmentPheromoneReplicationNodeFailingAllInfo.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
