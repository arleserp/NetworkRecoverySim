...
public class NetworkEnvironmentReplicationTopologyBuilder extends Environment {
    ...
    public NetworkEnvironmentReplicationTopologyBuilder(Vector<Agent> _agents, SimpleLanguage _language, Graph<GraphElements.MyVertex, String> gr) {
        super(_agents);
    ...
    public void setAgentsDie(int agentsDie) {
        NetworkEnvironmentReplicationTopologyBuilder.agentsDie = agentsDie;
    }
    ...
    public void increaseAgentsDie() {
        synchronized (NetworkEnvironmentReplicationTopologyBuilder.class) {
            NetworkEnvironmentReplicationTopologyBuilder.agentsDie++;
        }
    }
