 ...
 */
public class DataReplicationGraphBuilderMain {
    ...
    public static void main(String[] args) {
        if (args.length >= 1) {
            ...
            DataReplicationGraphBuilderScenario w = new DataReplicationGraphBuilderScenario(SimulationParameters.popSize, SimulationParameters.pf);
            w.init();
            w.run();
        } else {
