 ...
 * Title: Agent</p>
 * <p>
 * Description: Abstract definition of an agent (it can be run in a
 * thread!!)</p>
 * <p>
...
public class Agent implements Runnable {
     ...
     * Agent Broker
     */
    protected Broker brokerPlayer = null;
    ...
    /**
     * Creates an agent with the given agent architecture, the agent program is
     * set to null
     *
     * @param _architecture Agent Architecture
     */
    ...
    /**
     * Creates an agent with the given program, the agent architecture is set to
     * null
     *
     * @param _program Agent Program
     */
     ...
     *
     * @param _visualizer Component used for visualizing the agent in the
     * environment
     */
    ...
    /**
     * Sets the agent broker
     *
     * @param _broker Agent Broker
     */
    public void setBroker(Broker _broker) {
        broker = _broker;
    }
    ...
    public Broker getBrokerPlayer() {
        return brokerPlayer;
    }

    public void setBrokerPlayer(Broker brokerPlayer) {
