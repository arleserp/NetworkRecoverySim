    ...
    private int carry(Collection<MyVertex> vs) {
        ...
        if (Math.random() <= q0) {
            for (int k = 0; k < vs.size(); k++) {
                if (((MyVertex) vs.toArray()[k]).getPh() != -1) {
                    dirPos = k;
                    break;
                }
            }
            ...
            for (int k = dirPos + 1; k < vs.size(); k++) {
                if (((MyVertex) vs.toArray()[k]).getPh() != -1 && ((MyVertex) vs.toArray()[dirPos]).getPh() > ((MyVertex) vs.toArray()[k]).getPh()) {
                    dirPos = k;
                }
            }
            ...
            temp.add(dirPos);
            for (int k = 0; k < vs.size(); k++) {
                if (((MyVertex) vs.toArray()[k]).getPh() == min) {
                    temp.add(k);
                }
            }
