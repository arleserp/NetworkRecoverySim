 ...
 */
public class NetworkConsumptionLocalNRecv extends ApplicationFrame {
     ...
     */
    private static final LogContext LOGGER = Log.createContext(NetworkConsumptionLocalNRecv.class);
     ...
     */
    public NetworkConsumptionLocalNRecv(final String title) {
        super(title);
        ...
        for (File file : files) {
            if (file.isDirectory() && file.getName().endsWith("localstatsrecv")) {
                ...
                Arrays.sort(filesInfo, new Comparator<File>() {
                    ...
                    public int compare(File f1, File f2) {
                        ...
                        try {
                            ...
                            Logger.getLogger(NetworkConsumptionLocalNRecv.class.getName()).log(Level.SEVERE, null, ex);
                        }
                ...
                for (File fileInfo : filesInfo) {
                    ...
                    if (fileInfo.isFile() && extension.equals("csv") && fileInfo.getName().startsWith("exp") && fileInfo.getName().contains("recv")) {
                        ...
                        try {
                            ...
                            Logger.getLogger(NetworkConsumptionLocalNRecv.class
                ...
                String localStatsNumberMsgRecv = "./" + file.getName() + "localNumberMsgRecv" + ".csv";
                PrintWriter escribirLocalStatsNumberMsgRecv = null;
                ...
                for (int k : sorted) {
                    ...
                    escribirLocalStatsNumberMsgRecv.close();
                ...
                try {
                    output = new FileOutputStream(file.getName() + "localNumberMsgRecv" + ".jpg");
    ...
    public static void main(final String[] args) {
        ...
        final NetworkConsumptionLocalNRecv demo = new NetworkConsumptionLocalNRecv("Local Number of Messages Received vs Time");
    }
}
