...
import static graphmetrics.NetworkConsumptionLocalNRecvMa.asSortedList;
 ...
 */
public class NetworkConsumptionLocalNSent extends ApplicationFrame {
     ...
     */
    private static final LogContext LOGGER = Log.createContext(NetworkConsumptionLocalNSent.class);
     ...
     */
    public NetworkConsumptionLocalNSent(final String title) {
        super(title);
        ...
        for (File file : files) {
            if (file.isDirectory() && file.getName().endsWith("localstatssent")) {
                ...
                Arrays.sort(filesInfo, new Comparator<File>() {
                    ...
                    public int compare(File f1, File f2) {
                        ...
                        try {
                            ...
                            Logger.getLogger(NetworkConsumptionLocalNSent.class.getName()).log(Level.SEVERE, null, ex);
                        }
                ...
                for (File fileInfo : filesInfo) {
                    ...
                    if (fileInfo.isFile() && extension.equals("csv") && fileInfo.getName().startsWith("exp") && fileInfo.getName().contains("sent")) {
                        ...
                        try {
                            ...
                            Logger.getLogger(NetworkConsumptionLocalNSent.class
                        ...
                        while (sc.hasNext()) {
                            ...
                            Double numberTotalMsgSent = Double.valueOf(data[1]);
                ...
                String localStatsNumberMsgSent = "./" + file.getName() + "localNumberMsgSent" + ".csv";
                PrintWriter escribirLocalStatsNumberMsgSent = null;
                ...
                for (int k : sorted) {
                    ...
                    try {
                        escribirLocalStatsNumberMsgSent = new PrintWriter(new BufferedWriter(new FileWriter(localStatsNumberMsgSent, true)));
                        escribirLocalStatsNumberMsgSent.println(st.getMin() + "," + st.getMedian() + "," + st.getMax());
                    } catch (IOException ex) {
                        Logger.getLogger(DataReplicationNodeFailingObserver.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    escribirLocalStatsNumberMsgSent.close();
                }

                JFreeChart chart = ChartFactory.createXYLineChart(
                        "Time vs Number of Messages Sent by Round" + file.getName(), "Time", "Number of Messages",
                ...
                try {
                    output = new FileOutputStream(file.getName() + "localNumberMsgSent" + ".jpg");
    ...
    public static void main(final String[] args) {
        ...
        final NetworkConsumptionLocalNSent demo = new NetworkConsumptionLocalNSent("Local Number of Messages Sent vs Time");
    }
}
