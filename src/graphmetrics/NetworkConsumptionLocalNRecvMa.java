 ...
 */
public class NetworkConsumptionLocalNRecvMa extends ApplicationFrame {
     ...
     */
    private static final LogContext LOGGER = Log.createContext(NetworkConsumptionLocalNRecvMa.class);
     ...
     */
    public NetworkConsumptionLocalNRecvMa(final String title) {
        super(title);
        ...
        for (File file : files) {
            if (file.isDirectory() && file.getName().endsWith("localstatsrecvMa")) {
                ...
                Arrays.sort(filesInfo, new Comparator<File>() {
                    ...
                    public int compare(File f1, File f2) {
                        ...
                        try {
                            ...
                            Logger.getLogger(NetworkConsumptionLocalNRecvMa.class.getName()).log(Level.SEVERE, null, ex);
                        }
                ...
                for (File fileInfo : filesInfo) {
                    ...
                    if (fileInfo.isFile() && extension.equals("csv") && fileInfo.getName().startsWith("exp") && fileInfo.getName().contains("recvMa")) {
                        ...
                        try {
                            ...
                            Logger.getLogger(NetworkConsumptionLocalNRecvMa.class
                        ...
                        while (sc.hasNext()) {
                            ...
                            datainRound.get(round).add(numberTotalMsgRecv);
                            last_round = round;
                        }
                        sc.close();
                ...
                String localStatsNumberMsgRecvMa = "./" + file.getName() + "localNumberMsgRecvMa" + ".csv";
                PrintWriter escribirLocalStatsNumberMsgRecvMa = null;
                ...
                for (int k : sorted) {
                    ...
                    try {
                        escribirLocalStatsNumberMsgRecvMa = new PrintWriter(new BufferedWriter(new FileWriter(localStatsNumberMsgRecvMa, true)));
                        escribirLocalStatsNumberMsgRecvMa.println(st.getMin() + "," + st.getMedian() + "," + st.getMax());
                    } catch (IOException ex) {
                        Logger.getLogger(DataReplicationNodeFailingObserver.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    escribirLocalStatsNumberMsgRecvMa.close();
                }

                JFreeChart chart = ChartFactory.createXYLineChart(
                        "Time vs Number of Messages Recv by Round Mobile Agents" + file.getName(), "Time", "Number of Messages",
                ...
                try {
                    output = new FileOutputStream(file.getName() + "localNumberMsgRecvMa" + ".jpg");
    ...
    public static void main(final String[] args) {
        ...
        final NetworkConsumptionLocalNRecvMa demo = new NetworkConsumptionLocalNRecvMa("Local Number of Messages Received vs Time");
    }
}
