 ...
 */
public class MemoryConsumption extends ApplicationFrame {
     ...
     */
    private static final LogContext LOGGER = Log.createContext(MemoryConsumption.class);
     ...
     */
    public MemoryConsumption(final String title) {
        super(title);
        ...
        for (File file : files) {
            if (file.isDirectory() && file.getName().endsWith("resources")) {
                ...
                Arrays.sort(filesInfo, new Comparator<File>() {
                    ...
                    public int compare(File f1, File f2) {
                        ...
                        try {
                            ...
                            Logger.getLogger(MemoryConsumption.class.getName()).log(Level.SEVERE, null, ex);
                        }
                ...
                for (File fileInfo : filesInfo) {
                    ...
                    if (fileInfo.isFile() && extension.equals("csv") && fileInfo.getName().startsWith("exp") && fileInfo.getName().contains("resources")) {
                        ...
                        try {
                            ...
                            Logger.getLogger(MemoryConsumption.class
                ...
                String localStatsMemFileName = "./" + file.getName() + "memoryConsumption" + ".csv";
                PrintWriter escribirLocalStatsMem = null;
                ...
                try {
                    output = new FileOutputStream(file.getName() + "memoryConsumption" + ".jpg");
