 ...
 */
public class NetworkConsumptionLocalSizeRecv extends ApplicationFrame {
     ...
     */
    private static final LogContext LOGGER = Log.createContext(NetworkConsumptionLocalSizeRecv.class);
     ...
     */
    public NetworkConsumptionLocalSizeRecv(final String title) {
        super(title);
        ...
        for (File file : files) {
            if (file.isDirectory() && file.getName().endsWith("localstatsrecv")) {
                ...
                Arrays.sort(filesInfo, new Comparator<File>() {
                    ...
                    public int compare(File f1, File f2) {
                        ...
                        try {
                            ...
                            Logger.getLogger(NetworkConsumptionLocalSizeRecv.class.getName()).log(Level.SEVERE, null, ex);
                        }
                ...
                for (File fileInfo : filesInfo) {
                    ...
                    if (fileInfo.isFile() && extension.equals("csv") && fileInfo.getName().startsWith("exp") && fileInfo.getName().contains("recv")) {
                        ...
                        try {
                            ...
                            Logger.getLogger(NetworkConsumptionLocalSizeRecv.class
                ...
                try {
                    output = new FileOutputStream(file.getName() + "localSizeMsgRecv" + ".jpg");
