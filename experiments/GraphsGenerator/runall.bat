...
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load smallworld+v+100+beta+0.5+degree+4.graph 10 0 carriers smallworld+v+100+beta+0.5+degree+4.loc
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load smallworld+v+100+beta+0.9+degree+4.graph 10 0 carriers smallworld+v+100+beta+0.9+degree+4.loc
