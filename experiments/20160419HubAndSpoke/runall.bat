...
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load hubandspoke+v+100.graph 10 0 carriers hubandspoke+v+100.loc -1
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load hubandspoke+v+100.graph 10 0 random hubandspoke+v+100.loc -1
