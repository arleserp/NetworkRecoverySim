...
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load scalefree+sn+4+eta+4+numSt+97.graph 10 0 carriers scalefree+sn+4+eta+4+numSt+97.loc -1
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load scalefree+sn+4+eta+2+numSt+97.graph 10 0 carriers scalefree+sn+4+eta+2+numSt+97.loc -1
...
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load scalefree+sn+4+eta+4+numSt+97.graph 10 0 random scalefree+sn+4+eta+4+numSt+97.loc -1
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load scalefree+sn+4+eta+2+numSt+97.graph 10 0 random scalefree+sn+4+eta+2+numSt+97.loc -1
...
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load  community+v+100+beta+0.9+degree+4+clusters+4.graph 10 0 carriers community+v+100+beta+0.9+degree+4+clusters+4.loc -1
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load community+v+100+beta+0.5+degree+4+clusters+4.graph 10 0 carriers community+v+100+beta+0.5+degree+4+clusters+4.loc -1
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load community+v+100+beta+0.3+degree+4+clusters+4.graph 10 0 carriers community+v+100+beta+0.3+degree+4+clusters+4.loc -1
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load community+v+100+beta+0.1+degree+4+clusters+4.graph 10 0 carriers community+v+100+beta+0.1+degree+4+clusters+4.loc -1

java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load community+v+100+beta+0.9+degree+4+clusters+4.graph 10 0 random community+v+100+beta+0.9+degree+4+clusters+4.loc -1
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load community+v+100+beta+0.5+degree+4+clusters+4.graph 10 0 random community+v+100+beta+0.5+degree+4+clusters+4.loc -1
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load community+v+100+beta+0.3+degree+4+clusters+4.graph 10 0 random community+v+100+beta+0.3+degree+4+clusters+4.loc -1
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load community+v+100+beta+0.1+degree+4+clusters+4.graph 10 0 random community+v+100+beta+0.1+degree+4+clusters+4.loc -1
...
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load lattice+r+10+c+10.graph 10 0 random lattice+r+10+c+10.loc -1
...
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load circle+v+100.graph 10 0 carriers circle+v+100.loc -1 
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load line+v+100.graph 10 0 carriers line+v+100.loc -1

java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load circle+v+100.graph 10 0 random circle+v+100.loc -1
java  -Xmx4200m -classpath NetworkSimulator.jar unalcol.agents.NetworkSim.SyncronizationMain load line+v+100.graph 10 0 random line+v+100.loc -1
